...
import { MetricBar } from '@/shared/components/charts/metric-bar';
import { ScoreGauge } from '@/shared/components/charts/score-gauge';
import { formatDuration } from '@/shared/lib/utils';
import { AHA_MIN_DEPTH_MM, AHA_MAX_DEPTH_MM, AHA_MIN_RATE, AHA_MAX_RATE } from '@/shared/lib/constants';
import type { SessionMetrics } from '@/shared/types/session';
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
                <ScoreGauge score={metrics.qualityScore} />
