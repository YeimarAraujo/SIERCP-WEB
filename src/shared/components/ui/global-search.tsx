...
export function GlobalSearch({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
    ...
    return (
        <div style={{ 
            ...
            <div 
                style={{ 
                    width: '100%', maxWidth: 650, background: 'var(--card)', borderRadius: 24, 
            ...
            >
                ...
                <div style={{ display: 'flex', alignItems: 'center', padding: '20px 24px', borderBottom: '1px solid var(--border)' }}>
                    ...
                    <input 
                        ...
                        style={{ flex: 1, border: 'none', outline: 'none', fontSize: 16, padding: '0 16px', fontWeight: 500, color: 'var(--foreground)' }}
                    />
                    {query && (
                                ...
                                return (
                                    ...
                                    >
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                                            <div style={{ width: 40, height: 40, borderRadius: 12, background: 'var(--muted)', border: '1px solid var(--muted)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--brand)' }}>
                                                <Icon size={20} />
                                            </div>
                                            <div>
