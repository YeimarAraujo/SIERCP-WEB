                        ...
                        <div style={{ display: 'grid', gap: 32 }}>
                            ...
                            <div>
                                <h3 style={{ margin: '0 0 24px 0', fontSize: 16, fontWeight: 800, color: 'var(--foreground)', display: 'flex', alignItems: 'center', gap: 10 }}>
                                    <Cpu size={20} style={{ color: 'var(--brand)' }} /> Información del Dispositivo
                                </h3>
                            ...
                            <div>
                                <h3 style={{ margin: '0 0 24px 0', fontSize: 16, fontWeight: 800, color: 'var(--foreground)', display: 'flex', alignItems: 'center', gap: 10 }}>
                                    <Wifi size={20} style={{ color: 'var(--brand)' }} /> Estado Inicial
                                </h3>
                                        ...
                                        {[
                                            ...
                                            <button
                                                ...
                                                style={{
                                                    ...
                                                    border: formData.status === opt.value ? `2px solid ${opt.color}` : '1px solid var(--border)',
                                                    background: formData.status === opt.value ? opt.bg : 'var(--muted)',
                                                    color: formData.status === opt.value ? opt.color : 'var(--text-secondary)',
