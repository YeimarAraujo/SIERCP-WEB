...
export default function StudentHomePage() {
    ...
    const stats = {
        totalSessions: user?.stats?.totalSessions || calculatedTotalSessions,
        averageScore: user?.stats?.averageScore || calculatedAverageScore,
        bestScore: user?.stats?.bestScore || calculatedBestScore,
