...
import { ActivityService } from '@/services/firestore.service';
...
export function NotificationsDrawer({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
    ...
    return (
        <div style={{ 
            ...
            <div 
                style={{ 
                    width: '100%', maxWidth: 400, background: 'var(--popover)', height: '100%', 
                    ...
                    <div style={{ display: 'grid', gap: 16 }}>
                        {loading ? (
                            ...
                            notifications.map((n) => {
                                ...
                                return (
                                    <div key={n.id} style={{ 
                                        padding: '16px', borderRadius: 20, background: 'var(--muted)', border: '1px solid var(--border)',
