...
import {
    LayoutDashboard, Heart, GraduationCap, Users, Cpu,
    Library, BarChart2, Pin, PinOff, LogOut
} from 'lucide-react';
...
const navItems: NavItem[] = [
    ...
    { label: 'Sesiones en vivo', href: '/admin/sessions', icon: Heart, badge: true },
    { label: 'Instructores', href: '/admin/instructors', icon: GraduationCap },
    { label: 'Estudiantes', href: '/admin/students', icon: Users },
    { label: 'Dispositivos', href: '/admin/devices', icon: Cpu, badge: true },
    { label: 'Reportes', href: '/admin/reports', icon: BarChart2 },
    { label: 'Cursos', href: '/admin/courses', icon: Library, badge: true, badgeColor: '#EC4899' },
];
