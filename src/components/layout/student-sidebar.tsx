...
const ITEMS = [
    { label: 'Inicio', href: '/student/home', icon: '⌂' },
    { label: 'Mis sesiones', href: '/student/history', icon: '📋' },
    { label: 'Cursos', href: '/student/courses', icon: '📚' },
    { label: 'Mi dispositivo', href: '/student/device', icon: '⊡' },
];
